# Change Log — pre-2.0.0 (Bookshelf.js 1.x and earlier)

Upstream [Bookshelf.js](https://github.com/bookshelf/bookshelf) history for versions released before the bookshelfv2 TypeScript rewrite. For 2.0.0 and later, see [../CHANGELOG.md](../CHANGELOG.md).
