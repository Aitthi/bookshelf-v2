...
import { BPromise } from './internal/promise.js';
...
```ts
import Bookshelf = require('./index.d.cts');
...
If `import = require('./index.d.cts')` referencing a `.d.cts` by literal name fails resolution, change the specifier to `'./index.cjs'` (NodeNext maps `.cjs` → `.d.cts`). Verify against the fixture; the fixture is the oracle.
...
If a relative `.d.cts`/`.js` specifier fails resolution under NodeNext, adjust to `'../index.cjs'` / `'../index.js'` as the fixture dictates.
